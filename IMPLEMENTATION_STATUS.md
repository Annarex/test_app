...
- ⚠️ **Не реализовано полностью:**
  - Извлечение данных из формы 0503317 (частично реализовано)
  - Формирование Таблицы 2 (доходы) - базовая структура есть, нужна доработка:
    - Фильтрация по уровням (ЛВЛ) через справочник
    - Вычисление процента исполнения для каждой строки
    - Форматирование данных
  - Формирование Таблицы 3 (расходы) - не реализовано
  - Замена всех меток из кода 1С (многие метки еще не обрабатываются)
  - Работа с диаграммами в Word (обновление данных диаграмм)
